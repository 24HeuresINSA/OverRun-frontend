  ...
  <div class="container-fluid">
    ...
    <div class="row m-2 mt-4">
      <div class="col text-end">
        ...
        >
          <button type="button" class="btn btn-primary" @click="showRaceModal">Ajouter course</button>
        ...
        <table class="table table-striped table-hover">
          ...
          <tbody>
            <tr>
              ...
              <td>7/10</td>
              <td>
                <router-link :to="{name: 'DisciplineDetails', params: {id: 'test'}}" >
                    <a href="" class="badge rounded-pill bg-secondary mx-1">Discipline 1</a>
                </router-link>
                <router-link :to="{name: 'DisciplineDetails', params: {id: 'test'}}" >
                    <a href="" class="badge rounded-pill bg-secondary mx-1">Discipline 1</a>
                </router-link>
              ...
              <td>
                <router-link :to="{name: 'CategoryDetails', params: {id: 'test'}}" >
                    <a href="" class="badge rounded-pill bg-secondary mx-1">Category 1</a>
                </router-link>
