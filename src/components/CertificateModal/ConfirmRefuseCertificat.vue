    ...
    <div class="col bg-light custom-modal m-auto rounded-3 mt-5">
      <div class="row pt-3">
        <div class="col">
          ...
          <p>
            Indique pourquoi le certificat de l'athlète est refusé. Cette raison
            sera celle indique dans le mail envoyer à l'athlète
          </p>
        </div>
        <div class="col-1">
      ...
      <form class="mx-5 my-4" @submit.prevent="sendReason">
...
export default defineComponent({
  ...
  methods: {
    closeModal() {
      this.$emit("closeConfirmRefuseCertificat");
    },
    sendReason() {
      this.$emit("sendReason", this.reason);
    },
  },
});
</script>
