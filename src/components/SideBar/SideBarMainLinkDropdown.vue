<template>
  <div class="container-fluid text-light" id="side-bar-main-link" @mouseover="hover = true" @mouseout="hover = false" @click="toggleDropdown" :class="{ active: isActive || childIsActive}">
    <div class="row text-start m-0 p-0">
      ...
      <div class="col p-0 text-end">
          ...
          <div v-else>
              <span class="material-icons centered-element" id="right-icon"> navigate_next </span>
          </div>
